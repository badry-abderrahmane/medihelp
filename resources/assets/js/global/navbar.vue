            ...
            <a href="#">{{ user.name }}</a>
					...
					<li class="dropdown auth-drp">
						...
						<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
							<li>
								<a href="#" disabled><i class="zmdi zmdi-account" ></i><span>Profile</span></a>
							</li>
							<li>
								<a href="#" disabled><i class="zmdi zmdi-card"></i><span>Mon balance</span></a>
							</li>
							<li>
								<a href="#" disabled><i class="zmdi zmdi-email"></i><span>Inbox</span></a>
							</li>
							<li>
								<a href="#" disabled><i class="zmdi zmdi-settings"></i><span>Paramètres</span></a>
							</li>
							<li class="divider"></li>
							...
							<!-- <li class="divider"></li> -->
							<li>
								<a href="/logout"><i class="zmdi zmdi-power"></i><span>Déconnexion</span></a>
							</li>
						</ul>
					</li>
				</ul>
