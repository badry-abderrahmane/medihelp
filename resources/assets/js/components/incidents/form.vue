    ...
    <part-panel>
      ...
      <form v-on:submit.prevent="onSubmit" @keydown="form.errors.clear($event.target.name)" slot="body">
        <div class="row">
          ...
          <part-input v-model="form" name="action" label="Action"></part-input>
          <part-input v-model="form" name="etat" label="Etat"></part-input>
          <part-input v-model="form" name="communication" label="Communication"></part-input>
        </div>
        <div class="row">
