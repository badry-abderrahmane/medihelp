<template lang="html">
  <div>
    ...
    <div class="col-md-6">
      <part-panel-danger>
        <h6 class="panel-title txt-light" slot="heading">Suppression Entreprise</h6>
        <div slot="body">
          <h4 class="text-danger text-center">Etes vous sur de vouloir supprimer cet entreprise?</h4>
          <div class="row"><br><br>
...
export default {
  ...
  methods:{
    deleteMe(){
      axios.delete('/entreprises/'+this.entrepriseId)
      .then(response => {
